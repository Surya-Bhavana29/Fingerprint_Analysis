...
main = tkinter.Tk()
main.title("Fingerprint Image Identification for Crime Detection") #designing main screen
...
def predict():
    ...
    msg = ''
    if predict == 0:
        cv2.putText(img, 'criminal', (10, 25),  cv2.FONT_HERSHEY_SIMPLEX,0.6, (0, 255, 255), 2)
        msg = 'criminal'
    else:
        cv2.putText(img, 'Live', (10, 25),  cv2.FONT_HERSHEY_SIMPLEX,0.6, (0, 255, 255), 2)
        msg = 'Live'
...
font = ('times', 16, 'bold')
title = Label(main, text='Fingerprint Image Identification for Crime Detectione', justify=LEFT)
